...
scripts/aggregate_v6_replay_comparisons.py --comparison out/release-native-lto/benchmark-results/v6-conservative-root-independent-rollback-touched-pass77/comparison.csv --comparison out/release-native-lto/benchmark-results/v6-conservative-root-independent-rollback-touched-repeat-pass78/comparison.csv --output out/release-native-lto/benchmark-results/v6-conservative-root-independent-rollback-touched-aggregate-pass77-78/comparison_aggregate.csv
