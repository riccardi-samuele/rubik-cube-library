...
- `release` configure/build/test: 19/19 tests.
- `release-native-lto` configure/build/test: 19/19 tests.
- `asan-ubsan` configure/build/test: 19/19 tests.
- Install/export consumer smoke test.
- Source archive validation.
- Fresh source-archive extraction build/test: 19/19 tests.
