...
| `release-native-lto` configure/build/test | Passed, 19/19 tests |
| `asan-ubsan` configure/build/test | Passed, 19/19 tests |
| Install/export consumer smoke test | Passed |
| Source archive validation | Passed |
| Source archive clean-tree build/test | Passed, 19/19 tests |
