...
- Add `SolveProfile::Embedded`, `Default`, and `Performance` profiles.
...
- Add CLI tools: `rubik-solve` and `rubik-bench`.
...
- Large local optimal acceleration is experimental and controlled by
  environment flags.
